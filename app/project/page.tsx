  ...
  const images = [
    {
      ...
      alt: '영화를 목록을 볼 수 있으며 검색기능을 활용하여 원하는 영화를 검색해 보세요. 영화를 장르별, 별점순, 이름순으로 나열 가능합니다.',
    },
    {
      src: '/images/project/2.png',
      alt: '영화에 대한 상세정보를 확인 가능합니다. 영화의 제목, 장르, 개봉일, 감독, 출연진, 줄거리 등 세부사항을 한눈에 볼 수 있도록 제공합니다. 영화에 대해 리뷰를 남겨 보며 소통이 가능해집니다.',
    },
    {
      src: '/images/project/3.png',
      alt: 'My profile에서는 회원 정보를 확인 가능합니다."나만의 영화리스트"를 통해 영화 찜목록을 확인하고"나만의 영화감상문"을 통해 영화를 기록하세요.',
    },
  ]
