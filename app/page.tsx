...
export default function Home() {
  return (
    <main className="min-h-screen p-10">
      ...
      {/* 프로젝트 진행 */}
      <div className="mb-8">
        <h1 className="text-center font-bold text-3xl mb-4 text-green-600">
          고양 HUb 프로젝트 진행방식
        </h1>
        <div className="mt-4 text-lg text-gray-700">
          <ul className="list-disc list-inside">
            <li className="mb-2">
              1. 만들어야 할 페이지를 나눠서 각자 한 페이지씩 맡아 진행
            </li>
            <li className="mb-2">2. 각자 깃허브에 올려 코드 공유</li>
            <li className="mb-2">3. 오류가 있는 부분 서로 도와주며 제작</li>
          </ul>
        </div>
      </div>
      ...
      <h1 className="text-center text-3xl mb-6 font-bold text-green-600">
        팀원소개
      </h1>
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
        {teamMembers.map((member, index) => (
          <div
            key={index}
            className="bg-[#b5c8b8] p-6 rounded-lg text-center shadow-md transition-transform transform "
          >
            <Image
              src={member.image}
              alt={member.name}
              ...
              className="mx-auto rounded-full mb-4 border-2 border-gray-300"
            />
